...
class TextOverlayFilter(VideoFilter):
    ...
    offset: IntVector = Field(lambda: IntVector(0, 0), name = "Offset", axes = ["X", "Y"], step = 1, display = "box")
    ...
    shadow_offset: IntVector = Field(lambda: IntVector(1, 1), name = "Shadow offset", axes = ["X", "Y"], step = 1, display = "box")
